"""
Application Principale - LinkedIn Prospector V3.1
Point d'entree racine et Tableau de Bord Principal (Dashboard).
"""
...
try:
    ...
    from components.charts import render_company_bar_chart, render_status_donut_chart, render_timeline_chart
    ...
    from app.components.charts import render_company_bar_chart, render_status_donut_chart, render_timeline_chart
    from app.components.metrics import render_kpi_cards
    from app.components.notifications import show_security_banner
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
        <div>
            ...
            <p style="color: #666666; font-size: 1rem; margin-top: 4px;">
                Vue synthétique de votre prospection de stage (Drones & Systèmes Embarqués).
            </p>
        </div>
    </div>
    """,
...
# Rafraichissement automatique du Dashboard si une prospection est en cours
if worker_status["is_running"]:
    import time
    time.sleep(2.0)
    st.rerun()